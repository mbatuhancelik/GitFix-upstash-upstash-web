...
else and then maintain it. This server would continously fetch updated prices
...
to run your business logic inside a serverless functions on a schedule.
...
database. I chose Redis here, because it's very simple to setup, but you can use
